...
import ExpenseParticularIndex from './views/tactical_requisition/ExpenseParticular/Index.vue'
import ExpenseParticularCreate from './views/tactical_requisition/ExpenseParticular/Create.vue'
...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: '/tactical_requisition/expense_particular/index',
        name: 'expense.particular.index',
        component: ExpenseParticularIndex
      },
      {
        path: '/tactical_requisition/expense_particular/create',
        name: 'expense.particular.create',
        component: ExpenseParticularCreate
      },
      {
