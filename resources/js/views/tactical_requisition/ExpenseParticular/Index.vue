...
export default {
  ...
  methods: {
      ...
      axios.post("/api/expense_particular/delete", data).then(
        (response) => {
          if (response.data.success) {
            ...
            // this.$socket.emit("sendData", { action: "expense-particular-delete" });
          }
          this.loading = false;
        },
        (error) => {
          ...
          axios.post("/api/expense_particular/store", data).then(
            (response) => {
              if (response.data.success) {
                ...
                this.expense_particulars.push(response.data.expense_particular);
              }
              else
              { 
                let errors = response.data;
    ...
    createExpenseParticular() {
      this.$router.push({ name: 'expense.particular.create' })
    },
